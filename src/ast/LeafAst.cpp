...
class AstIdentifier : public AstNode {
 ...
 public:
  AstIdentifier(unsigned long long iden_id) : AstNode() { id = iden_id; }
  virtual int getType() { return AstIdentifierType; }
  virtual unsigned long long getID() { return id; }
};
/*
 * 这里需要解释一下
...
class AstIdentifierName : public AstIdentifier {
 ...
 public:
  AstIdentifierName(String id) : AstIdentifier(-1) { name = id; }
  virtual int getType() { return AstIdentifierType; }
...
class AstNumber : public AstNode {
 ...
 public:
  virtual int getType() { return AstNumberType; }
  virtual int getNumberType() { return number_type; }
};
...
class AstFloatNumber : public AstNumber {
 ...
 public:
  ...
  virtual float getVal() { return value; }
};
...
class AstString : public AstNode {
 ...
 public:
  AstString(String str) : AstNode() { val = str; }
  virtual int getType() { return AstStringType; }
  virtual String getVal() { return val; }
};

class AstNull : public AstNode {
 public:
  virtual int getType() { return AstNullType; }
};

class AstBreak : public AstNode {
 public:
  AstBreak() : AstNode(){};
  virtual int getType() { return AstBreakType; }
};
}  // namespace ast
}  // namespace stamon
