...
class IntegerType : public DataType {
 ...
 public:
  IntegerType(int value) : DataType(IntegerTypeID) { val = value; }
...
class FloatType : public DataType {
 ...
 public:
  FloatType(float value) : DataType(FloatTypeID) { val = value; }
...
class DoubleType : public DataType {
 ...
 public:
  DoubleType(double value) : DataType(DoubleTypeID) { val = value; }
  virtual double getVal() { return val; }
